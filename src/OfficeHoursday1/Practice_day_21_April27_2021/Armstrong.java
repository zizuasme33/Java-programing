...
public class Armstrong {
    /*
        Create a method that will accept a number and determine if that number is an
        Armstrong number or not. Return a boolean.

    A number is an Armstrong number if the single digits of the number
